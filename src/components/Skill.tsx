...
const Skill = () => {
  return (
    <div className="my-3 md:flex min-h-screen items-center mx-7">
      <div className="md:w-1/2 w-full mr-3" data-aos="zoom-in-right">
        <p className="text-blue-600 md:text-2xl text-xl mb-3">Hard Skills</p>
        <h2 className="md:text-4xl text-3xl text-center md:text-left font-bold">
      ...
      <div
        ...
        data-aos="zoom-in"
      >
        <div className="md:w-20 md:h-20  w-16 h-16 rounded-md p-2 bg-blue-600 hover:bg-gray-200 shadow-md ">
